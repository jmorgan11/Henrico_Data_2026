...
def dataset_queries(dataset, prefix):
    ...
    try:
        ...
        selected = arcpy.SelectLayerByAttribute_management(
            in_layer_or_view=dataset,
            selection_type="NEW_SELECTION",
            where_clause="community_flooding = 'F'")
        ...
        selected = arcpy.SelectLayerByAttribute_management(
            in_layer_or_view=dataset,
            selection_type="NEW_SELECTION",
            where_clause="fema_sfha = 'F' AND community_flooding = 'F'")
        ...
        if prefix == "Buildings":
            ...
            selected = arcpy.SelectLayerByAttribute_management(
                in_layer_or_view=dataset,
                selection_type="NEW_SELECTION",
                where_clause="fema_sfha = 'F' AND sq_ft > 600")
            ...
            selected = arcpy.SelectLayerByAttribute_management(
                in_layer_or_view=dataset,
                selection_type="NEW_SELECTION",
                where_clause="community_flooding = 'F' AND sq_ft > 600")
